/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 84f1b04760a91d8843246961a688aff3)
// Runtime types generated with workerd@1.20260511.1 2025-11-18 nodejs_compat
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		...
		EMAIL_FROM: string;
		FAL_KEY: string;
		FAL_PRICING_KEY: string;
		GOOGLE_CLIENT_ID: string;
		GOOGLE_CLIENT_SECRET: string;
		LANGFUSE_BASE_URL: string;
		LANGFUSE_PROMPTS_ENABLED: string;
		...
		MOTION_BATCH_WORKFLOW: Workflow<Parameters<import("./src/server").MotionBatchWorkflow['run']>[0]['payload']>;
		...
		SHOT_VARIANT_WORKFLOW: Workflow<Parameters<import("./src/server").ShotVariantWorkflow['run']>[0]['payload']>;
		UPSCALE_SHOT_VARIANT_WORKFLOW: Workflow<Parameters<import("./src/server").UpscaleShotVariantWorkflow['run']>[0]['payload']>;
		VISUAL_PROMPT_SCENE_WORKFLOW: Workflow<Parameters<import("./src/server").VisualPromptSceneWorkflow['run']>[0]['payload']>;
		MOTION_PROMPT_SCENE_WORKFLOW: Workflow<Parameters<import("./src/server").MotionPromptSceneWorkflow['run']>[0]['payload']>;
		MUSIC_PROMPT_WORKFLOW: Workflow<Parameters<import("./src/server").MusicPromptWorkflow['run']>[0]['payload']>;
		RECAST_CHARACTER_WORKFLOW: Workflow<Parameters<import("./src/server").RecastCharacterWorkflow['run']>[0]['payload']>;
		LOCATION_MATCHING_WORKFLOW: Workflow<Parameters<import("./src/server").LocationMatchingWorkflow['run']>[0]['payload']>;
		SHOT_IMAGES_WORKFLOW: Workflow<Parameters<import("./src/server").ShotImagesWorkflow['run']>[0]['payload']>;
		TALENT_MATCHING_WORKFLOW: Workflow<Parameters<import("./src/server").TalentMatchingWorkflow['run']>[0]['payload']>;
		CHARACTER_BIBLE_WORKFLOW: Workflow<Parameters<import("./src/server").CharacterBibleWorkflow['run']>[0]['payload']>;
		LOCATION_BIBLE_WORKFLOW: Workflow<Parameters<import("./src/server").LocationBibleWorkflow['run']>[0]['payload']>;
		VISUAL_PROMPT_WORKFLOW: Workflow<Parameters<import("./src/server").VisualPromptWorkflow['run']>[0]['payload']>;
		MOTION_PROMPT_WORKFLOW: Workflow<Parameters<import("./src/server").MotionPromptWorkflow['run']>[0]['payload']>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ADMIN_EMAILS" | "API_KEY_ENCRYPTION_KEY" | "BETTER_AUTH_SECRET" | "DOPPLER_CONFIG" | "DOPPLER_ENVIRONMENT" | "DOPPLER_PROJECT" | "EMAIL_FROM" | "FAL_KEY" | "FAL_PRICING_KEY" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "LANGFUSE_BASE_URL" | "LANGFUSE_PROMPTS_ENABLED" | "LANGFUSE_PUBLIC_KEY" | "LANGFUSE_SECRET_KEY" | "OPENROUTER_KEY" | "R2_ACCESS_KEY_ID" | "R2_ACCOUNT_ID" | "R2_BUCKET_NAME" | "R2_SECRET_ACCESS_KEY" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET" | "VITE_APP_NAME" | "VITE_APP_URL" | "VITE_PUBLIC_POSTHOG_HOST" | "VITE_PUBLIC_POSTHOG_PROJECT_TOKEN" | "VITE_R2_PUBLIC_ASSETS_DOMAIN" | "E2E_TEST">> {}
}
