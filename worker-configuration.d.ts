/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 15b5e8bcbb1af5acac8948cb76bc7d95)
...
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		...
		FRAME_PROMPT_WORKFLOW: Workflow<Parameters<import("./src/server").FramePromptWorkflow['run']>[0]['payload']>;
		...
		FRAME_PROMPT_BATCH_WORKFLOW: Workflow<Parameters<import("./src/server").FramePromptBatchWorkflow['run']>[0]['payload']>;
		...
		ASSET_WORKFLOW: Workflow<Parameters<import("./src/server").AssetGenerationWorkflow['run']>[0]['payload']>;
	}
	interface TestEnv {
		R2_PUBLIC_ASSETS_BUCKET: R2Bucket;
		R2_STORAGE_BUCKET: R2Bucket;
